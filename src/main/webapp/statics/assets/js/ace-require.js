require.config({
	...
	shim: {
		'bootstrap': {
			deps: ['../components/jquery/dist/jquery.min.js']
		},
		'ace': {
			deps: ['../components/jquery/dist/jquery.min.js', '../components/bootstrap/dist/js/bootstrap.js']
		},
		'ace-elements': {
...
require(['../components/jquery/dist/jquery.min.js', '../components/bootstrap/dist/js/bootstrap.js', '../assets/js/ace.js', '../assets/js/ace-extra.js', '../assets/js/ace-elements.js'], function($) {
