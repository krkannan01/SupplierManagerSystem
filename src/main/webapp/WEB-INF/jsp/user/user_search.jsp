...
<head>
    ...
    <style type="text/css">
        .layui-layer-dialog { width: 656px; }
    </style>
...
<div class="main-container ace-save-state" id="main-container">
    ...
    <% request.setAttribute("active","User-UserPrivilege"); %>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div>
                            <table id="simple-table" class="table table-bordered table-hover">
                                <thead>
                                <tr>
                                    <th class="center" style="width: 8%;"> <label class="pos-rel"> <input type="checkbox" class="ace" /> <span class="lbl"></span> </label> </th>
...
<script type="text/javascript">
    ...
    //      缺点：耦合高
    var has_user_delete = false; <shiro:hasAnyPermission name="admin,user:delete">has_user_delete = true;</shiro:hasAnyPermission>
    var has_user_insert = false; <shiro:hasAnyPermission name="admin,user:insert">has_user_insert = true;</shiro:hasAnyPermission>
    var has_user_update = false; <shiro:hasAnyPermission name="admin,user:update">has_user_update = true;</shiro:hasAnyPermission>
</script>
...
<script src="${pageContext.request.contextPath}/statics/js/project/user/search_user.js"></script>
