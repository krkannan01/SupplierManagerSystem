...
<body class="gray-bg">
	...
	<script src="${pageContext.request.contextPath}/statics/js/project/oper_log/list.js"></script>
	<script type="text/javascript">
        ...
        var detailFlag = false; <shiro:hasPermission name="admin">detailFlag = true;</shiro:hasPermission>
	</script>
</body>
</html>