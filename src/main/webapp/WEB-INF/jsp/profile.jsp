...
<%
  ...
  if (user.getHeadImg() != null && user.getHeadImg() != "") headImg = "headImg/"+user.getHeadImg();
                  ...
                  <div>
                    <!-- #section:pages/profile.picture -->
                                                  <span class="profile-picture">
                                                      <img id="headImg" class="editable img-rounded" name="headImg" style="width: 136px; height: 150px;" alt="头像" src="${pageContext.request.contextPath}/statics/<%=headImg%>" />
                                                  </span>
